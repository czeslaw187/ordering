    ...
    return ( 
        <div className='pt-32 bg-gradient-to-br from-slate-200 to-lime-300 rounded-md h-screen w-full'>
            ...
            <form className='w-6/12 h-4/6 mx-auto px-auto py-5 border-2 border-teal-400 rounded-md flex flex-col'>
                ...
                <input className='w-5/12 ml-11 h-10 rounded-md' type="text" name='postCode' id='postCode' onChange={(e)=>{handleChange(e)}} value={finalOrder.postCode} required/>
                <label className='w-10/12 mx-auto' htmlFor='city'>City</label>
                <input className='w-5/12 ml-11 h-10 rounded-md' type="text" name='city' id='city' onChange={(e)=>{handleChange(e)}} value={finalOrder.city} required />
            </form>   
